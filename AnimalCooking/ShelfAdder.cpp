...
Shelf* ShelfAdder::makeShelf(Pickable* u, std::array<Entity*, 2>& player, jute::jValue& jsonShelf)
{
	...
	else if (jsonShelf["texture"].as_string() == "EncimeraVertAbajo")
	{
		t = Resources::TextureId::EncimeraVertAbajo;
		lookingAt = Orientation::Down;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraVertSin_SinBordeIzq")
	{
		lookingAt = Orientation::Down;
		t = Resources::TextureId::EncimeraVertSin_SinBordeIzq;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraVertSin_SinBordeDer")
	{
		lookingAt = Orientation::Down;
		t = Resources::TextureId::EncimeraVertSin_SinBordeDer;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraVEsquinaSuperior_SinBordeDer")
	{
		lookingAt = Orientation::Down;
		t = Resources::TextureId::EncimeraVEsquinaSuperior_SinBordeDer;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraVEsquinaSuperior_SinBordeIzq")
	{
		lookingAt = Orientation::Down;
		t = Resources::TextureId::EncimeraVEsquinaSuperior_SinBordeIzq;
	}
	else if (jsonShelf["texture"].as_string() == "EsquinaSupIzqSinBordeDer")
	{
		lookingAt = Orientation::Down;
		t = Resources::TextureId::EsquinaSupIzqSinBordeDer;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraHorizConBordes")
	{
		lookingAt = Orientation::Down;
		t = Resources::TextureId::EncimeraHorizConBordes;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraVertSinBordeSup")
	{
		lookingAt = Orientation::Down;
		t = Resources::TextureId::EncimeraVertSinMantelDcha;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraDerVertCon")
	{
		lookingAt = Orientation::Down;
		t = Resources::TextureId::EncimeraDerVertCon;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraIzqVertCon")
	{
	   lookingAt = Orientation::Down;
	   t = Resources::TextureId::EncimeraIzqVertCon;
    }
	else if (jsonShelf["texture"].as_string() == "EncimeraVEsquinaSuperior_SinBordes")
	{
	    lookingAt = Orientation::Down;
	...
	else if (jsonShelf["texture"].as_string() == "Encimera")
	{
	lookingAt = Orientation::Down;
	t = Resources::TextureId::Encimera;
	}
	else if (jsonShelf["texture"].as_string() == "EncimeraHorizSinBordes")
	{
	lookingAt = Orientation::Down;
	t = Resources::TextureId::EncimeraHorizSinBordes;
	}
	else { //CornerLeft
		lookingAt = Orientation::Down;
