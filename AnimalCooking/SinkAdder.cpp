...
SinkAdder::SinkAdder(EntityManager* em, jute::jValue& jsonLevel, jute::jValue& jsonGeneral, std::array<Entity*, 2>& player, const double casillaX, const double casillaY) : em(em)
{
	...
	for (int i = 0; i < sinks_.size(); ++i) {
		...
		else if (sinks_[i]["texture"].as_string() == "FregaderoFlipBordeArriba")
		{
			t1 = SDLGame::instance()->getTextureMngr()->getTexture(Resources::TextureId::FregaderoFlipBordeArriba);
			t2 = SDLGame::instance()->getTextureMngr()->getTexture(Resources::TextureId::FregaderoFlipONBordeArriba);
		}
		else if (sinks_[i]["texture"].as_string() == "FregaderoFlipSinIzq")
		{
			t1 = SDLGame::instance()->getTextureMngr()->getTexture(Resources::TextureId::FregaderoFlipSinIzq);
			t2 = SDLGame::instance()->getTextureMngr()->getTexture(Resources::TextureId::FregaderoFlipSinIzqON);
		}
		else if (sinks_[i]["texture"].as_string() == "fregaderoAbajoEsq")
		{
			t1 = SDLGame::instance()->getTextureMngr()->getTexture(Resources::TextureId::fregaderoAbajoEsq);
			t2 = SDLGame::instance()->getTextureMngr()->getTexture(Resources::TextureId::fregaderoAbajoEsqON);
		}
		else if (sinks_[i]["texture"].as_string() == "FregaderoAislado")
		{
			t1 = SDLGame::instance()->getTextureMngr()->getTexture(Resources::TextureId::FregaderoAislado);
			t2 = SDLGame::instance()->getTextureMngr()->getTexture(Resources::TextureId::FregaderoAisladoON);
		}
